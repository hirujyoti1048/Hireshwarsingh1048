...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1284168830,7011234092').split()] # For Multiple Id Use One Space Between Each.

auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1284168830,7011234092').split()]  # For Multiple Id Use One Space Between Each.
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002882911458')
